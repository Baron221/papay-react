...
import { setChosenRestaurants, setRandomRestaurants, setTargetProducts } from "../../screens/RestaurantPage/slice";
...
const actionDispatch = (dispatch: Dispatch) => ({
   ...
   setChosenRestaurant: (data: Restaurant) => dispatch(setChosenRestaurants(data)),
