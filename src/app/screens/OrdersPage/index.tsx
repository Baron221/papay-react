            ...
            >
                ...
                <Stack className="order_right">
                    <Stack className="order_info_box">
                        <Stack sx={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                            <Box className="order_user_img">
                                <img src="./restaurant/brooke.svg" className="order_user_avatar" alt="" />
                                <Box className="order_user_icon_box">
                                    <img src="/restaurant/brooke.svg" className="order_user_prof_img" alt="" />
                                </Box>
                            </Box>
                    ...
                    <Stack className="order_info_box">
                        ...
                        <input type="text" name="card_creator" placeholder="Bakhromjon" className="card_input" />
